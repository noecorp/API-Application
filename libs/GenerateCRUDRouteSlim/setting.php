        ...
        <div class="card-block">
            ...
            <form class="form-inline" action="routes_generated.php" method="post">
                ...
                <div class="md-form form-group">
                    ...
                    <input type="text" id="form91" class="form-control validate" placeholder="Your host" name="host">
                </div>

                <div class="md-form form-group">
                    <i class="fa fa-database prefix"></i>
                    <input type="text" id="form92" class="form-control validate" placeholder="Your database name" name="databaseName">
                </div>

                <div class="md-form form-group">
                    <i class="fa fa-user prefix"></i>
                    <input type="text" id="form92" class="form-control validate" placeholder="User MySQL" name="user">
                </div>

                <div class="md-form form-group">
                    <i class="fa fa-lock prefix"></i>
                    <input type="password" id="form92" class="form-control validate" placeholder="Password MySQL" name="pwd">
                </div>
